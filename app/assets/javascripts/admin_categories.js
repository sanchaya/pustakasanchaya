...
(function() {
  ...
  let renameModal, mergeModal, categoriesMergeMultipleModal;
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    categoriesMergeMultipleModal = new bootstrap.Modal(document.getElementById('categoriesMergeMultipleModal'), { keyboard: false });
  ...
  function openMergeMultipleModal() {
    ...
    categoriesMergeMultipleModal.show();
  }
